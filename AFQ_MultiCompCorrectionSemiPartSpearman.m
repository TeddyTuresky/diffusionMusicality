function [alphaFWE, statFWE, clusterFWE, stats] = AFQ_MultiCompCorrectionSemiPartSpearman(data,y,alpha,method,cThresh,reg)
            ...
            case('corr')
                for ii = 1:nperm
                    ...
                    for kk = 1:size(data,2)
                        mdl = fitlm(reg,data(:,kk));
                        data(:,kk) = mdl.Residuals.Raw;
                        clearvars mdl;
                    end
